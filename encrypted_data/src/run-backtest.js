...
(async () => {
  ...
  // 5. آماده‌سازی گزینه‌های بکتست (مانند کد اصلی شما)
  let backtestOptions = {
    code: strategyCode,
  ...
  // تابع استخراج تنظیمات از استراتژی (بدون تغییر)
  ...
  // بررسی پارامترهای اجباری (بدون تغییر)
